...
human_pathways = REST.kegg_list("pathway", "mmu").read()
repair_pathways = []
...
# 将字典保存到文件
with open('./KEGG_all_pathway_mmu.pkl', 'wb') as f:
...
# Save to CSV
df.to_csv('human_regulatory_interaction_networks.csv', index=False)
