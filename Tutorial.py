...
if __name__ == '__main__':
    ...
    train_filename = 'Cancer_datasets/S39_T_cell_BRCA_output.csv'  # Please enter your gene expression profile (ending with csv or xlsx). If you want to process your sequencing data before this, such as matrix completion and quality control, please refer to Supplementary S2
    args.pca_file = 'result/S39_T_cell_pca_model.pkl'
    args.save_label = "Training_S39_T_cell_data"
    ...
    trainer = NetGPT(args)
    train_model_file = trainer.train(train_filename)
    ...
    # test_filename = 'Cancer_datasets/S33_T_cell_BRCA_output.csv'
    # args.pca_file = 'result/S33_T_cell_pca_model.pkl'
    #
    # # 2. Instantiate a NetGPT class
    # trainer = NetGPT(args)
    #
